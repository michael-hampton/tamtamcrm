...
return [
    ...
    'invalid_refund_amount'                                => 'Refund amount is to high',
    'invalid_invoice'                                      => 'Invoice is not a valid invoice',
    'invoice_already_paid'                                 => 'The invoice has already been paid',
    'invalid_order_totals'                                 => 'Totals do not match',
    'invalid_payment_credit'                               => 'Credit is not valid',
    'invalid_payment_invoice'                              => 'Invoice is not valid',
    'duplicate_invoice'                                    => 'Duplicate invoice found',
    'invalid_credit_status'                                => 'Credit is at the wrong status',
    'invalid_invoice_status'                               => 'Invoice is at the wrong status',
    'invalid_payment_customer'                             => 'Cannot create payment for different customers',
    'invalid_refund_customer'                              => 'Cannot create refund for different customers',
    'invalid_payment_amount'                               => 'Payment amount cannot be more that the invoice total',
    'invalid_discount_amount'                              => 'The discount amount is more that the order total',
    'agent'                                                => 'Agent',
    'products'                                             => 'Products',
    'tasks'                                                => 'Tasks',
    'expenses'                                             => 'Expenses',
    ...
    'email_changed'                                        => 'The email address on your user account has been changed to :email. Please click the button below to verify your email address. If you did not create an account, no further action is required.',
    'email_changed_button'                                 => 'Verify Email Address',
    ...
    'forgot_password_subject'                              => 'Reset Password Notification',
    'forgot_password_body'                                 => 'You are receiving this email because we received a password reset request for your account. This password reset link will expire in :count minutes. If you did not request a password reset, no further action is required.',
    'forgot_password_button'                               => 'Reset Password',
    'user_confirmed_subject'                               => 'Please confirm your account.',
    'user_confirmed_body'                                  => 'Account confirmation has been requested, please click on the button below to verify your account',
    'user_confirmed_button'                                => 'Verify Account',
    'new_user'                                             => 'New User',
    'view_payment'                                         => 'View Payment',
    'notification_invoice_created_subject'                 => 'An invoice :invoice for :total was created for customer :customer',
    'notification_invoice_created'                         => 'A new invoice has been created for :customer.',
    'notification_purchase_order_created_subject'          => 'A purchase order :purchase_order for :total was created for company :company',
    'notification_purchase_order_created'                  => 'A new purchase order has been created for :company.',
    'notification_quote_created_subject'                   => 'A quote :quote for :total was created for customer :customer',
    'notification_quote_created'                           => 'A new quote has been created for :customer.',
    'notification_recurring_invoice_created_subject'       => 'A recurring invoice :recurring_invoice for :total was created for customer :customer',
    'notification_recurring_invoice_created'               => 'A new recurring invoice has been created for :customer.',
    'notification_recurring_quote_created_subject'         => 'A recurring quote :recurring_quote for :total was created for customer :customer',
    'notification_recurring_quote_created'                 => 'A new credit has been created for :customer.',
    'notification_credit_created_subject'                  => 'A credit :credit for :total was created for customer :customer',
    'notification_credit_created'                          => 'A new credit has been created for :customer.',
