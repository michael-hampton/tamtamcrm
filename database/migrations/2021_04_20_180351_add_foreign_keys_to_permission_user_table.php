...
class AddForeignKeysToPermissionUserTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('permission_user', function (Blueprint $table) {
            ...
            $table->foreign('permission_id', 'permission_user_ibfk_3')->references('id')->on('permissions')->onUpdate('NO ACTION')->onDelete('CASCADE');
        });
    }
    ...
    public function down()
    {
        Schema::table('permission_user', function (Blueprint $table) {
            ...
            $table->dropForeign('permission_user_ibfk_3');
        });
    }
}
